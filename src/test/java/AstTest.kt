...
class AstTest {
    ...
    internal fun `expr test 1`() {
        ...
        val expected = "StatementsNode(codeStrings=[UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=0), operand=SquareBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=6), operand=MathExpNodes(nodes=[ValueNode(value=Token(type=INTEGER, text='2', pos=11)), ValueNode(value=Token(type=INTEGER, text='3', pos=16)), ValueNode(value=Token(type=INTEGER, text='4', pos=21)), ValueNode(value=Token(type=INTEGER, text='2', pos=25)), OperationNode(operation=Token(type=MINUS, text='-', pos=23)), OperationNode(operation=Token(type=MULTIPLICATION, text='*', pos=18)), OperationNode(operation=Token(type=PLUS, text='+', pos=13)), ValueNode(value=Token(type=INTEGER, text='1', pos=31)), OperationNode(operation=Token(type=PLUS, text='+', pos=29))]))]))])"
    ...
    internal fun `expr test 2`() {
        ...
        val expected = "StatementsNode(codeStrings=[UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=0), operand=SquareBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=6), operand=MathExpNodes(nodes=[ValueNode(value=Token(type=INTEGER, text='2', pos=11)), ValueNode(value=Token(type=INTEGER, text='4', pos=15)), OperationNode(operation=Token(type=MULTIPLICATION, text='*', pos=13)), ValueNode(value=Token(type=INTEGER, text='1', pos=19)), OperationNode(operation=Token(type=PLUS, text='+', pos=17))]))]))])"
        Assertions.assertEquals(expected, actual)
    }
    ...
    internal fun `expr test 3`() {
        ...
        val expected = "StatementsNode(codeStrings=[UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=0), operand=SquareBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=6), operand=MathExpNodes(nodes=[MathFunctionNode(mathFun=Token(type=SQRT, text='sqrt', pos=11), arguments=[ValueNode(value=Token(type=INTEGER, text='9', pos=16))]), ValueNode(value=Token(type=INTEGER, text='1', pos=21)), OperationNode(operation=Token(type=PLUS, text='+', pos=19))]))]))])"
        Assertions.assertEquals(expected, actual)
    }
    ...
    internal fun `expr test 4`() {
        ...
        val expected = "StatementsNode(codeStrings=[UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=0), operand=SquareBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=6), operand=MathExpNodes(nodes=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$a', pos=11)), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$b', pos=16)), OperationNode(operation=Token(type=PLUS, text='+', pos=14)), ValueNode(value=Token(type=INTEGER, text='2', pos=21)), OperationNode(operation=Token(type=PLUS, text='+', pos=19))]))]))])"
        Assertions.assertEquals(expected, actual)
    }
    ...
    internal fun `expr test 5`() {
        ...
        val expected = "StatementsNode(codeStrings=[UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=0), operand=SquareBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=6), operand=MathExpNodes(nodes=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$a', pos=12)), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$b', pos=17)), OperationNode(operation=Token(type=PLUS, text='+', pos=15)), ValueNode(value=Token(type=INTEGER, text='2', pos=22)), OperationNode(operation=Token(type=PLUS, text='+', pos=20))]))]))])"
    ...
    internal fun `expr test 7`() {
        ...
        val expected = "StatementsNode(codeStrings=[UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=0), operand=SquareBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=6), operand=MathExpNodes(nodes=[ValueNode(value=Token(type=INTEGER, text='123', pos=12)), ValueNode(value=Token(type=INTEGER, text='312', pos=20)), OperationNode(operation=Token(type=PLUS, text='+', pos=17))]))]))])"
        Assertions.assertEquals(expected, actual)
    }
    ...
    internal fun `switch case test 3`() {
        ...
        val expected = "StatementsNode(codeStrings=[SwitchNode(string=Token(type=LINK_VARIABLE, text='\$x', pos=7), cases=[SwitchCase(value=Token(type=LINK_VARIABLE, text='\$z', pos=14), body=CurlyBracesNodes(nodes=[BinOperationNode(operator=Token(type=SET, text='set', pos=20), whomAssign=VariableNode(variable=Token(type=VARIABLE, text='y1', pos=24)), whatAssign=SquareBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=28), operand=MathExpNodes(nodes=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y', pos=33)), ValueNode(value=Token(type=INTEGER, text='1', pos=36)), OperationNode(operation=Token(type=PLUS, text='+', pos=35))]))])), UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=40), operand=QuotationNodes(nodes=[StringNode(string='match '), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$z', pos=52)), StringNode(string='. '), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y', pos=56)), StringNode(string=' + '), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$z', pos=61)), StringNode(string=' is '), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y1', pos=67))]))])), SwitchCase(value=Token(type=STRING, text='one', pos=78), body=CurlyBracesNodes(nodes=[BinOperationNode(operator=Token(type=SET, text='set', pos=84), whomAssign=VariableNode(variable=Token(type=VARIABLE, text='y1', pos=88)), whatAssign=SquareBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=92), operand=MathExpNodes(nodes=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y', pos=97)), ValueNode(value=Token(type=INTEGER, text='1', pos=100)), OperationNode(operation=Token(type=PLUS, text='+', pos=99))]))])), UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=104), operand=QuotationNodes(nodes=[StringNode(string='match one '), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y', pos=120)), StringNode(string=' plus one is '), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y1', pos=135))]))])), SwitchCase(value=Token(type=DEFAULT, text='default', pos=145), body=CurlyBracesNodes(nodes=[UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=155), operand=QuotationNodes(nodes=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$x', pos=161)), StringNode(string=' none')]))]))], isSubstitutionsAllowed=true)])"
    ...
    internal fun `switch case test 4`() {
        ...
        val expected = "StatementsNode(codeStrings=[SwitchNode(string=Token(type=LINK_VARIABLE, text='\$x', pos=7), cases=[SwitchCase(value=Token(type=LINK_VARIABLE, text='\$z', pos=15), body=CurlyBracesNodes(nodes=[BinOperationNode(operator=Token(type=SET, text='set', pos=21), whomAssign=VariableNode(variable=Token(type=VARIABLE, text='y1', pos=25)), whatAssign=SquareBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=29), operand=MathExpNodes(nodes=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y', pos=34)), ValueNode(value=Token(type=INTEGER, text='1', pos=37)), OperationNode(operation=Token(type=PLUS, text='+', pos=36))]))])), UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=41), operand=QuotationNodes(nodes=[StringNode(string='match '), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$z', pos=53)), StringNode(string='. '), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y', pos=57)), StringNode(string=' + '), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$z', pos=62)), StringNode(string=' is '), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y1', pos=68))]))])), SwitchCase(value=Token(type=STRING, text='one', pos=79), body=CurlyBracesNodes(nodes=[BinOperationNode(operator=Token(type=SET, text='set', pos=85), whomAssign=VariableNode(variable=Token(type=VARIABLE, text='y1', pos=89)), whatAssign=SquareBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=93), operand=MathExpNodes(nodes=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y', pos=98)), ValueNode(value=Token(type=INTEGER, text='1', pos=101)), OperationNode(operation=Token(type=PLUS, text='+', pos=100))]))])), UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=105), operand=QuotationNodes(nodes=[StringNode(string='match one '), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y', pos=121)), StringNode(string=' plus one is '), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y1', pos=136))]))])), SwitchCase(value=Token(type=DEFAULT, text='default', pos=146), body=CurlyBracesNodes(nodes=[UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=156), operand=QuotationNodes(nodes=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$x', pos=162)), StringNode(string=' none')]))]))], isSubstitutionsAllowed=false)])"
    ...
    internal fun `lambda test 1`() {
        ...
        val expected = "StatementsNode(codeStrings=[BinOperationNode(operator=Token(type=SET, text='set', pos=0), whomAssign=VariableNode(variable=Token(type=VARIABLE, text='inc', pos=4)), whatAssign=LambdaExprNode(args=[VariableNode(variable=Token(type=VARIABLE, text='x', pos=10))], body=CurlyBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=14), operand=MathExpNodes(nodes=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$x', pos=19)), ValueNode(value=Token(type=INTEGER, text='1', pos=24)), OperationNode(operation=Token(type=PLUS, text='+', pos=22))])), UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=27), operand=ValueNode(value=Token(type=STRING, text='hello', pos=32)))]), exprAsString=StringNode(string='{x} {expr \$x + 1; puts hello;}')))])"
    ...
    @Test
    internal fun `lambda test 3`() {
        val code = "set inc {{x y} {expr \$x + \$y}}"
        val asl = Parser(Lexer(code).lexAnalysis()).parseCode()
        val actual = asl.toString()

        val expected = "StatementsNode(codeStrings=[BinOperationNode(operator=Token(type=SET, text='set', pos=0), whomAssign=VariableNode(variable=Token(type=VARIABLE, text='inc', pos=4)), whatAssign=LambdaExprNode(args=[VariableNode(variable=Token(type=VARIABLE, text='x', pos=10)), VariableNode(variable=Token(type=VARIABLE, text='y', pos=12))], body=CurlyBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=16), operand=MathExpNodes(nodes=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$x', pos=21)), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y', pos=26)), OperationNode(operation=Token(type=PLUS, text='+', pos=24))]))]), exprAsString=StringNode(string='{x y} {expr \$x + \$y}')))])"
    ...
    internal fun `lambda test 5`() {
        ...
        val expected = "StatementsNode(codeStrings=[ApplyNode(lambdaExpr=LambdaExprNode(args=[VariableNode(variable=Token(type=VARIABLE, text='a', pos=8)), VariableNode(variable=Token(type=VARIABLE, text='b', pos=10))], body=CurlyBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=14), operand=MathExpNodes(nodes=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$a', pos=19)), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$b', pos=24)), OperationNode(operation=Token(type=PLUS, text='+', pos=22))]))]), exprAsString=null), args=[ValueNode(value=Token(type=INTEGER, text='1', pos=29)), ValueNode(value=Token(type=INTEGER, text='2', pos=31))])])"
    ...
    internal fun `lambda test 7`() {
        ...
        val expected = "StatementsNode(codeStrings=[UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=0), operand=SquareBracesNodes(nodes=[ApplyNode(lambdaExpr=LambdaExprNode(args=[VariableNode(variable=Token(type=VARIABLE, text='a', pos=14)), VariableNode(variable=Token(type=VARIABLE, text='b', pos=16))], body=CurlyBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=20), operand=MathExpNodes(nodes=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$a', pos=25)), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$b', pos=30)), OperationNode(operation=Token(type=PLUS, text='+', pos=28))]))]), exprAsString=null), args=[ValueNode(value=Token(type=INTEGER, text='1', pos=35)), ValueNode(value=Token(type=INTEGER, text='2', pos=37))])]))])"
    ...
    internal fun `lambda test 9`() {
        ...
        val expected = "StatementsNode(codeStrings=[ProcNode(functionName=StringNode(string='foo2'), args=[VariableNode(variable=Token(type=VARIABLE, text='lambda', pos=11)), VariableNode(variable=Token(type=VARIABLE, text='a', pos=18)), VariableNode(variable=Token(type=VARIABLE, text='b', pos=20))], body=CurlyBracesNodes(nodes=[ReturnNode(returnValue=SquareBracesNodes(nodes=[ApplyNode(lambdaExpr=VariableNode(variable=Token(type=LINK_VARIABLE, text='\$lambda', pos=39)), args=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$a', pos=47)), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$b', pos=50))])]))])), UnarOperationNode(operator=Token(type=PUTS, text='puts', pos=56), operand=SquareBracesNodes(nodes=[ProcCallNode(functionName=StringNode(string='foo2'), args=[LambdaExprNode(args=[VariableNode(variable=Token(type=VARIABLE, text='x', pos=69)), VariableNode(variable=Token(type=VARIABLE, text='y', pos=71))], body=CurlyBracesNodes(nodes=[UnarOperationNode(operator=Token(type=EXPR, text='expr', pos=75), operand=MathExpNodes(nodes=[VariableNode(variable=Token(type=LINK_VARIABLE, text='\$x', pos=81)), ValueNode(value=Token(type=INTEGER, text='4', pos=86)), OperationNode(operation=Token(type=MULTIPLICATION, text='*', pos=84)), VariableNode(variable=Token(type=LINK_VARIABLE, text='\$y', pos=90)), OperationNode(operation=Token(type=PLUS, text='+', pos=88)), ValueNode(value=Token(type=INTEGER, text='2', pos=95)), OperationNode(operation=Token(type=MINUS, text='-', pos=93))]))]), exprAsString=StringNode(string='{x y} {expr {\$x * 4 + \$y - 2}}')), ValueNode(value=Token(type=INTEGER, text='2', pos=100)), ValueNode(value=Token(type=INTEGER, text='4', pos=102))])]))])"
